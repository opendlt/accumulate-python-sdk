...
Usage:
    python run_again_devnet_simple.py
"""
...
class DevnetRunner:
    ...
    def stage_3_examples(self) -> bool:
        ...
        for script_name, extra_args in examples:
            ...
            if rc == 0 and ("SUCCESS" in stdout or "success" in stdout):
                print(f"PASS {script_name} succeeded on devnet")
                success_count += 1
            else:
                print(f"FAIL {script_name} failed on devnet, trying mock...")
                ...
                if rc2 == 0 and ("SUCCESS" in stdout2 or "success" in stdout2):
                    print(f"PASS {script_name} succeeded with --mock")
                    success_count += 1
                else:

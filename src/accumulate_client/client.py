...
class AccumulateClient:
    ...
    def call(self, method: str, params: Any = None) -> Any:
        ...
        response = self.session.post(
            self.server_url, json=payload, headers={"Content-Type": "application/json"}
        )
    ...
    def query_block(self, request: Dict[str, Any]) -> Dict[str, Any]:
        """Query block information"""
        return self.call("query-block", request)

    def query_chain(self, request: Dict[str, Any]) -> Dict[str, Any]:
        """Query chain entries"""
        return self.call("query-chain", request)

    def submit(self, request: Dict[str, Any]) -> Dict[str, Any]:
        """Submit a transaction"""
        return self.call("submit", request)

    def submit_multi(self, request: Dict[str, Any]) -> Dict[str, Any]:
        """Submit multiple transactions"""
        return self.call("submit-multi", request)

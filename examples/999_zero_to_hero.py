...
"""Zero to Hero: Complete Accumulate workflow from key generation to token transfer"""
...
class AccumulateDemo:
    """Demo class for Accumulate zero-to-hero workflow"""

    def __init__(self):
        # Load environment variables
        self.v2_url = os.environ.get('ACC_RPC_URL_V2', 'http://localhost:26660/v2')
        self.v3_url = os.environ.get('ACC_RPC_URL_V3', 'http://localhost:26660/v3')
        self.faucet_account = os.environ.get('ACC_FAUCET_ACCOUNT',
                                            'acc://a21555da824d14f3f066214657a44e6a1a347dad3052a23a/ACME')

        self.v2_client = AccumulateClient(self.v2_url)
        self.v3_client = AccumulateClient(self.v3_url)

        # Keys and URLs storage
